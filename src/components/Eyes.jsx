...
const Eyes = () => {
  ...
  useEffect(()=>{
    window.addEventListener("mousemove",(e)=>{
      ...
      let deltaX = mouseX - window.innerWidth/2;//window.innerWidth for screen position
      let deltaY = mouseY - window.innerHeight/2

      var angle = Math.atan2(deltaY,deltaX) * (180/Math.PI); //atan2 measures the clockwise angle in radians between x,y
      setrotate(angle-180);
    })
  })
